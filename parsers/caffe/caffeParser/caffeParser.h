...
private:
    ...
    std::vector<nvinfer1::PluginField> parseInnerProductWithAxisParam(const trtcaffe::LayerParameter& msg, CaffeWeightFactory& weightFactory, BlobNameToTensor& tensors);
    template <typename T>
